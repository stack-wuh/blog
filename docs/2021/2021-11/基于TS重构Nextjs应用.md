...
![](https://cdn.wuh.site/2021-12/2021-12-05-020136.png)
...
主题切换，不再使用原方案，改为使用脚本实现。同时，bubble泡泡也改为使用脚本实现。你可以直接下载[bubble.js][5](https://cdn.wuh.site/scripts/bubble.js)脚本体验。
...
每一次更新博客之后，都需要更新维护的rss.xml文件，只有这个文件更新了，订阅器才会有更新推送。现在我把这个功能集成到了我的管理后台，我的feed文件托管在aliOSS，这个是我的[feed][7](https://cdn.wuh.site/common/rss.xml)。
...
[5]:	https://cdn.wuh.site/scripts/bubble.js
[6]:	https://www.npmjs.com/package/feed "rss-feed"
[7]:	https://cdn.wuh.site/common/rss.xml

[image-1]:	https://cdn.wuh.site/2021-12/2021-12-04-070306.png
[image-2]:	https://cdn.wuh.site/2021-12/2021-12-04-073516.png
[image-3]:	https://cdn.wuh.site/common/aria.png
[image-4]:	https://cdn.wuh.site/2021-12/2021-12-04-084011.png
